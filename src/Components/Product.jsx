...
function Product({ product, addToCart }) {
            ...
            <div style={{
                ...
                <Card className='mt-2 border-0 shadow-sm' style={{ 'width': '100%' }}>
                    ...
                    <Container className='text' style={{
                        ...
                        {/* {
                            console.log(isLive(product.productId) + " Live or not")
                            
                        } */}

                        {
                            product.live ? butt() :  <Button size='sm' style={{
                                "marginLeft": "3rem"
                            }} className='my-3' color='success' >Not Available</Button>
                        }
                        {/* <Button tag={Link} to={'/viewproduct/' + product.productId} size='sm' className='my-3' color='success' >View Product</Button> */}
    ...
    // return(<>
    //     <br></br>
    //     { product && product.live ? getProductHtml(): <h1>Not available</h1>}
    // </>)
